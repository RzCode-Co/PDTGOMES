...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $verificar_produto_sql = "SELECT id, nome, quantidade FROM estoque WHERE nome = '$nome_peca' AND referencia = '$referencia' AND marca = '$marca' AND aplicacao = '$aplicacao' AND ano = '$ano'";
    ...
    if ($result->num_rows > 0) {
        ...
        echo '<script>
                    alert("Produto não encontrado ou valor de venda não atende aos critérios.");
                    window.location.href = "Venda.php";
                </script>';
    }
}
